 ...
 * A simple picture may have an associated file name and a title.  
 * A simple picture has pixels, width, and height.  
 * A simple picture uses a BufferedImage to hold the pixels. 
 * You can show a simple picture in a PictureFrame (a JFrame).  
 * You can also explore a simple picture.
 * 
